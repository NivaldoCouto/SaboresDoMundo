	...
	<div class="modal-dialog modal-notify modal-info" role="document">
		...
		<div class="modal-content text-center">
			...
			<div class="modal-header d-flex justify-content-center">
				<p class="heading">Deseja Receber Notifica√ß√£o</p>
				<button type="button" class="close white-text" data-dismiss="modal" aria-label="Close">
					<span aria="true">&times;</span>
				</button>
			</div>
			...
			<div class="modal-footer flex-center">
				...
				<input type="submit" name="action" form="form-notifica" class="btn btn-danger" value="N√£o">
			</div>
		</div>
		<!--/.Content-->
	</div>
			...
			<div class="modal-body">
				<div class="row d-flex justify-content-center align-items-center" align="center">
					<form action="control/usuario.php" method="POST">
						...
						<button type="button" class="btn btn-success" data-dismiss="modal" aria-label="Close">N√£o</button>
...
<script type="text/javascript">
	$(document).ready(function() {
        ...
        // Detecta se o dispositivo estè´° no iOS
const isIos = () => {
...
// Verifica se deve exibir notificaè´Æè´™o popup de instalaè´Æè´™o:
